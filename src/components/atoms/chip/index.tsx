...
const Chip: ChipComponent = ({
	...
	return (
		<button
			type="button"
			className={combine(
				tw`inline-flex flex-row items-center appearance-none text-xl py-1 border border-solid text-gray-700 dark:text-gray-200 border-gray-200 dark:border-gray-600 rounded-full transition-colors`,
				active
					? tw`border-gray-200 bg-gray-200 focus:bg-gray-200 dark:bg-gray-600 dark:focus:bg-gray-600`
					: tw`bg-transparent focus:bg-gray-100 dark:focus:bg-gray-700`,
