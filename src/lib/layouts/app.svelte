...
<script lang="ts">
    ...
    $: applyActive = (path: string) =>
        $page.url.pathname.startsWith(path) ? 'text-blue-500 dark:text-blue-400 bg-gray-100 dark:bg-blue-300/20' : ''
</script>

<nav
    class="sticky z-30 top-0 flex justify-between items-center h-16 px-4 border-b bg-white dark:bg-gray-800 dark:border-b-gray-700/75"
>
    <a
    ...
    <form
        ...
        class="flex items-center gap-2 w-[48ch] pl-4 pr-1.5 h-12 bg-gray-100 dark:bg-gray-700 rounded"
    >
        <SearchIcon size="24" class="text-gray-500 dark:text-gray-400" />
        <input
    ...
    <div class="flex justify-end items-center gap-2 text-gray-500 dark:text-gray-400 px-2">
        <a
            href="/collection"
