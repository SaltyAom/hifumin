...
<section class="flex flex-col w-full max-w-xl mx-auto py-4 px-4">
    <h1 class="text-4xl text-gray-800 font-semibold pt-12">Settings</h1>
    <p class="text-lg text-gray-500 mt-3 mb-12">Adjust Platform behavior</p>
